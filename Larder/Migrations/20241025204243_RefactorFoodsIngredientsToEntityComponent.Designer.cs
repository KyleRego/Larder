...
namespace Larder.Migrations
{
    ...
    [Migration("20241025204243_RefactorFoodsIngredientsToEntityComponent")]
    partial class RefactorFoodsIngredientsToEntityComponent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Larder.Models.Food", b =>
                {
                    ...
                    b.HasOne("Larder.Models.Item", "Item")
                        .WithOne("Food")
                        .HasForeignKey("Larder.Models.Food", "ItemId");
            ...
            modelBuilder.Entity("Larder.Models.Ingredient", b =>
                {
                    ...
                    b.HasOne("Larder.Models.Item", "Item")
                        .WithOne("Ingredient")
                        .HasForeignKey("Larder.Models.Ingredient", "ItemId");
