...
namespace Larder.Migrations
{
    ...
    [Migration("20241127173855_AddQuantityComponentAndRemoveFromIngredient")]
    partial class AddQuantityComponentAndRemoveFromIngredient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Larder.Models.ItemComponents.QuantityComponent", b =>
                {
                    ...
                    b.OwnsOne("Larder.Models.Quantity", "Quantity", b1 =>
                        {
                            b1.Property<string>("QuantityComponentId")
                                .HasColumnType("TEXT");
                            ...
                            b1.HasKey("QuantityComponentId");

                            b1.HasIndex("UnitId");

                            b1.ToTable("QuantityComponent");

                            b1.WithOwner()
                                .HasForeignKey("QuantityComponentId");
                    ...
                    b.OwnsOne("Larder.Models.Quantity", "QuantityPerItem", b1 =>
                        {
                            b1.Property<string>("QuantityComponentId")
                                .HasColumnType("TEXT");
