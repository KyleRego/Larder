...
namespace Larder.Migrations
{
    ...
    [Migration("20250411224755_AddImageContentPropertyToItem")]
    partial class AddImageContentPropertyToItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Larder.Models.ItemComponents.Container", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Larder.Models.Item", b =>
                {
                    b.HasOne("Larder.Models.ItemComponents.Container", "ContainedIn")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Larder.Models.ItemComponents.Container", b =>
                {
                    b.HasOne("Larder.Models.Item", "Item")
                        .WithOne("Container")
                        .HasForeignKey("Larder.Models.ItemComponents.Container", "ItemId");
