    ...
    return (
        <div className="text-center fs-4 d-flex flex-column h-100">
            <div className="container flex-grow-1">
                ...
                <p className="mb-4">
                    Larder is an inventory-tracking application for meticulously analyzing the cost and nutrition of foods and ingredients as they are bought, cooked, and consumed. It is free and open source: <a href="https://github.com/KyleRego/Larder">Larder source code</a>
                </p>
                <p className="">
