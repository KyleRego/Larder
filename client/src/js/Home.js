...
export default function Home()
{
    return <>
        ...
        <p>
            Larder is a free software application (<a href="https://github.com/KyleRego/Larder/blob/main/LICENSE.txt">GNU AGPLv3</a>)
        ...
        <p>
            This is not really ready to be used yet though.
        </p>
    </>;
}
